...
const Accordion = ({ project, isOpen, toggleAccordion }) => {
  ...
  return (
    <div className=" col-span-1 mb-4 border-md text-gray-400 opacity-100 z-10 transition-all duration-300 hover:text-white  hover:opacity-100  overflow-hidden md:overflow-scroll">
      ...
      >
        <div 
          ref={contentRef}
          className=" header-font p-10  bg-black text-white  overflow-auto"
        >
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3 mt-10 ">
            {project.images.map((image, index) => (
              <Image
                ...
                className="rounded-lg object-cover mt-5 pb-5 "
              />
            ))}
          </div>
